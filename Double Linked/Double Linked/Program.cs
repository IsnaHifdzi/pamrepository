...
namespace DoubleLinkedList
{
    ...
    class DoubleLinkedList
    {
        ...
        public bool delNode(int rollNo)/*Deletes the specified node*/
        {
            ...
            /*if the node to be is in between the list then the
        ...
        /*Traverses the list in the reserve direction*/
        public void revtraverse()
        {
            ...
            {
                Console.WriteLine("\nRecords in the descending order of" + "roll nymbers are:\n");
                Node currentNode;
            ...
            while (true)
            {
                try
                {
                    Console.WriteLine("\n Menu" +
                        ...
                        "\n 3. View all records in the ascending ofder of roll numbers" +
                        "\n 4. View all records in the descending order if roll numbers" +
